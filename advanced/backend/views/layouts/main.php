    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        if(isset($this->params['test'])){
            echo '<li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>'.$this->params['test'].'</span></a></li>';
            //echo '<li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>'.$this->blocks['advertisement'].'</span></a></li>';
        }                            
        ?>
      </ul>
