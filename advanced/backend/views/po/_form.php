                ...
                <div class="item panel panel-default"><!-- widgetBody -->
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <button type="button" class="add-item btn btn-success btn-xs"><i class="glyphicon glyphicon-plus">Po Items</i></button>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <?= $form->field($modelsPoItem, "[{$i}]quantify")->textInput(['maxlength' => true]) ?>
                            </div>
                        </div><!-- .row -->
                    </div>
                </div>
