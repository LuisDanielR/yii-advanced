...
use backend\modules\departmentsid\models\Departments;

/**
 * DepartmentsSearch represents the model behind the search form about `backend\modules\departmentsid\models\Departments`.
 */
